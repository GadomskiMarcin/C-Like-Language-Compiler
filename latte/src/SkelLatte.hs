...
transProgram x = case x of
  AbsLatte.Prog _ topdefs -> failure x

transTopDef :: Show a => AbsLatte.TopDef' a -> Result
transTopDef x = case x of
  AbsLatte.FnDef _ type_ ident args block -> failure x
  AbsLatte.ClassDef _ ident classprops -> failure x
  AbsLatte.ClassExtDef _ ident1 ident2 classprops -> failure x

transClassProp :: Show a => AbsLatte.ClassProp' a -> Result
transClassProp x = case x of
  AbsLatte.CAttribute _ type_ ident -> failure x
  AbsLatte.CMethod _ type_ ident args block -> failure x
...
transType x = case x of
  ...
  AbsLatte.Class _ ident -> failure x
...
transExpr x = case x of
  ...
  AbsLatte.EAtr _ expr ident -> failure x
  AbsLatte.ECMethodApp _ expr ident exprs -> failure x
  AbsLatte.ENull _ expr -> failure x
  AbsLatte.EArr _ type_ expr -> failure x
  AbsLatte.EArrGet _ expr1 expr2 -> failure x
  AbsLatte.ENew _ ident -> failure x

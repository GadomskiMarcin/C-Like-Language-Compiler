...
instance Print (AbsLatte.TopDef' a) where
  prt i = \case
    ...
    AbsLatte.ClassDef _ id_ classprops -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, doc (showString "{"), prt 0 classprops, doc (showString "}")])
    AbsLatte.ClassExtDef _ id_1 id_2 classprops -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_1, doc (showString "extends"), prt 0 id_2, doc (showString "{"), prt 0 classprops, doc (showString "}")])

instance Print (AbsLatte.ClassProp' a) where
  prt i = \case
    AbsLatte.CAttribute _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString ";")])
    AbsLatte.CMethod _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (AbsLatte.Type' a) where
  prt i = \case
    ...
    AbsLatte.Class _ id_ -> prPrec i 0 (concatD [prt 0 id_])
...
instance Print (AbsLatte.Expr' a) where
  prt i = \case
    ...
    AbsLatte.EAtr _ expr id_ -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_])
    AbsLatte.ECMethodApp _ expr id_ exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    ...
    AbsLatte.ENew _ id_ -> prPrec i 5 (concatD [doc (showString "new"), prt 0 id_])
